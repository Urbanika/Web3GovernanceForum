...
const labelEditor = (
  <div className="col-lg-12 mb-2">
    ...
    <Typeahead
      ...
      placeholder="proposals, idea, debate, problem, etc"
      ...
      {props.transactionHashes ? (
        ...
        <>
          ...
          <div class="card border-light">
            <div class="card-body">
              <p class="card-title fw-bold fs-6">Submit to BOS HACKS forum</p>

              <p class="text-muted w-75 my-1">
                {state.postType === "Idea"
                  ? "Post an idea for your hack submission, ask a question or form a team."
